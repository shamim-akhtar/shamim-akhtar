...
**A responsive web-based CPF Simulator (2026 Edition).** <br> It was designed to forecast retirement balances based on the upcoming CPF rules (2025 and 2026), specifically the Special Account closure at age 55 and increase in the ordinary wages of SGD 8,000. Built using HTML5, Vanilla JavaScript, Tailwind CSS, and Chart.js.

This simulator is created for educational purposes only and serves as a tool to help users visualise the impact of regulatory changes on their future savings. The calculations used in this simulator are derived from publicly available information regarding the 2026 Ordinary Wage ceiling, annual limits, and fund transfer logic.

While this simulator aims to provide useful estimates, it is not a substitute for official CPF statements or professional financial advice. Always refer to your official CPF account or consult a financial advisor for accurate and personalised financial planning.
...
[![](https://github.com/shamim-akhtar/tpcraw/blob/main/images/image_01.PNG)](https://shamim-akhtar.github.io/tpcraw/)
